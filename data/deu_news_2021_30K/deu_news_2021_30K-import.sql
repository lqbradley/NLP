...
CREATE DATABASE `deu_news_2021_30K`;

USE `deu_news_2021_30K`;
...
LOAD DATA LOCAL INFILE 'deu_news_2021_30K-words.txt' INTO TABLE words CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'deu_news_2021_30K-sentences.txt' INTO TABLE sentences CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'deu_news_2021_30K-co_s.txt' INTO TABLE co_s CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'deu_news_2021_30K-co_n.txt' INTO TABLE co_n CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'deu_news_2021_30K-inv_w.txt' INTO TABLE inv_w CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'deu_news_2021_30K-inv_so.txt' INTO TABLE inv_so CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'deu_news_2021_30K-sources.txt' INTO TABLE sources CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'deu_news_2021_30K-meta.txt' INTO TABLE meta CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'deu_news_2021_30K-sentences_tagged.txt' INTO TABLE sentences_tagged CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'deu_news_2021_30K-sentences_tagged_ud17.txt' INTO TABLE sentences_tagged_ud17 CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'deu_news_2021_30K-words_pos_base.txt' INTO TABLE words_pos_base CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'deu_news_2021_30K-sim_w_co.txt' INTO TABLE sim_w_co CHARACTER SET utf8mb4;
